...
.previous-month-date {
  ...
  .previous-month-date:focus, .previous-month-date.focus {
    opacity: 1; }
  .previous-month-date:not([disabled]):not(.disabled):active, .previous-month-date:not([disabled]):not(.disabled).active,
...
.next-month-date {
  ...
  .next-month-date:focus, .next-month-date.focus {
    opacity: 1; }
  .next-month-date:not([disabled]):not(.disabled):active, .next-month-date:not([disabled]):not(.disabled).active,
