...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
	<ul class="navbar-nav mr-auto" aria-label="<@liferay.language key="site-pages" />" role="menubar">
		...
		<#assign x++ />
			...
			<li class="nav-item ">
				<a class="nav-link" href="#a${nav_item.getLayoutId()}" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="collapseTramites">${nav_item.getName()}</a>
				<#else>
				<li class="${nav_item_css_class} nav-item " id="layout_${nav_item.getLayoutId()}" role="presentation">
				<a class="nav-link" aria-labelledby="layout_${nav_item.getLayoutId()}" ${nav_item_attr_has_popup} href="${nav_item.getURL()}" ${nav_item.getTarget()} role="menuitem"><@liferay_theme["layout-icon"] layout=nav_item_layout /> ${nav_item.getName()}</a>
...
<!-- ....................................... -->
  ...
  <#if nav_child.hasChildren()>
                ...
                <ul class="lista-menu">
				  <#list nav_child.getChildren() as nav_grandchild>
							...
							<li ${nav_grandchild_attr_selected} id="layout_${nav_grandchild.getLayoutId()}" role="presentation">
								<a aria-labelledby="layout_${nav_grandchild.getLayoutId()}" href="${nav_grandchild.getURL()}" ${x} ${nav_grandchild.getTarget()} role="menuitem">${nav_grandchild.getName()}</a></li>
				    </#list>
                   </ul>
                  </div> 
            ...
            <#else>       
				...
				<a aria-labelledby="layout_${nav_child.getLayoutId()}" href="${nav_child.getURL()}" ${nav_child.getTarget()} role="menuitem">${nav_child.getName()}</a></li>
            </#if> 
